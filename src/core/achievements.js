...
const ACHIEVEMENTS = [
  ...
  { id: 'fusion_first', name: '첫 합성', description: '첫 몬스터 합성을 했다.', icon: '🔀',
    condition: (type) => type === 'fusion' },
  { id: 'egg_first', name: '첫 알 발견', description: '몬스터 알을 발견했다.', icon: '🥚',
    condition: (type) => type === 'egg' },
  { id: 'craft_first', name: '첫 제작', description: '아이템을 제작했다.', icon: '🔨',
    condition: (type) => type === 'craft' },
  { id: 'quest_3', name: '의뢰 해결사', description: '의뢰 3개를 완료했다.', icon: '📋',
    condition: (type, val) => type === 'quest' && val >= 3 },
  { id: 'quest_9', name: '마스터 의뢰인', description: '모든 의뢰를 완료했다.', icon: '🏆',
    condition: (type, val) => type === 'quest' && val >= 9 },
  { id: 'daily_3', name: '꾸준한 도전자', description: '일일 도전 3회 클리어.', icon: '📅',
    condition: (type, val) => type === 'daily' && val >= 3 },
  { id: 'superboss', name: '신을 넘어서', description: '근원신을 쓰러뜨렸다.', icon: '⭐',
    condition: (type) => type === 'superboss_defeat' },
  { id: 'money_10k', name: '부자', description: '소지금 10,000원 달성.', icon: '💰',
    condition: (type, val) => type === 'money' && val >= 10000 },
  { id: 'money_100k', name: '대부호', description: '소지금 100,000원 달성.', icon: '💎',
    condition: (type, val) => type === 'money' && val >= 100000 },
  { id: 'ng_plus', name: '끝없는 여정', description: '뉴게임+를 시작했다.', icon: '🔄',
    condition: (type) => type === 'new_game_plus' },
];
